...
tables=(
    ...
    "terraform-locks-qa"
    "terraform-locks-values-prod"
    "terraform-locks-values-staging"
    "terraform-locks-values-qa"
    "terraform-locks-vpc"
    "terraform-locks-jenkins-sonarqube-values"
    "terraform-locks-jenkins"
    "terraform-locks-sonarqube"
)
